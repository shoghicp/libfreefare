 ...
 */
static FreefareTag _ntag21x_tag_new (nfc_device *device, nfc_target target)
{
    FreefareTag tag;
...
static FreefareTag _ntag21x_tag_reuse (FreefareTag old_tag)
{
    FreefareTag tag;
...
bool is_ntag21x(FreefareTag tag)
{
 ...
 */
bool ntag21x_is_auth_supported (nfc_device *device, nfc_iso14443a_info nai)
{
  int ret;
  uint8_t cmd_step1[1];
  uint8_t res_step1[8];
