/*-
 * Copyright (C) 2009, 2010, 2017 Romain Tartiere, Romuald Conty, Martin Dagarin (SloCompTech).
 *
...
int ntag_21x_get_info(FreefareTag tag); // Get all information about tag (size,vendor ...)
